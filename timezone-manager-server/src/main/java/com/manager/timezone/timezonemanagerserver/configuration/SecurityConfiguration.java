...
import com.manager.timezone.timezonemanagerserver.auth.JwtAuthenticationEntryPoint;
import com.manager.timezone.timezonemanagerserver.auth.JwtAuthenticationFilter;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
                ...
                .antMatchers(AUTH_WHITELIST).permitAll().antMatchers("/api/v1/users/**").permitAll().anyRequest()
                .authenticated();
